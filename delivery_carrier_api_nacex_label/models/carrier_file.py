    ...
    def action_done(self):
        if self.carrier_id:
            if self.carrier_id.name == 'NACEX API' and not self.carrier_tracking_ref:
                ...
                data = {
                    'del_cli': self.carrier_id.carrier_account_id.nacex_api_del_cli,
                    'num_cli': self.carrier_id.carrier_account_id.nacex_api_num_cli,
                    'fec': datetime.now().strftime('%d/%m/%Y'),
                    'tip_ser': self.carrier_id.carrier_account_id.nacex_api_tip_ser,
                    'tip_cob': self.carrier_id.carrier_account_id.nacex_api_tip_cob,
                    'exc': '0',
