            ...
            if self.carrier_id.name == 'NACEX API' and not self.carrier_tracking_ref:
                ...
                if self.number_of_packages == 1:
                    ...
                    data = {
                        ...
                        'bul': '1',
                        'kil': '2',
                        'nom_ent': self.partner_id.name.encode('utf-8'),
                        'per_ent': self.partner_id.name.encode('utf-8'),
                        'dir_ent': street.encode('utf-8'),
                        'pais_ent': self.partner_id.country_id.code,
                        'cp_ent': self.partner_id.zip,
                        'pob_ent': self.partner_id.city.encode('utf-8'),
