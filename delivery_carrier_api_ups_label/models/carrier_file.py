...
class CarrierAccount(models.Model):
    ...
    ups_type = fields.Boolean(string='UPS API')
    ...
    def action_done(self):
        if self.carrier_id:
            if 'UPS WS' in self.carrier_id.name and not self.carrier_tracking_ref:
                ...
                d = upsrest.UPSAPI(
                    self.carrier_id.carrier_account_id.ups_api_username,
                    self.carrier_id.carrier_account_id.ups_api_password,
                    self.carrier_id.carrier_account_id.ups_api_license,
                    'prod'
                    )
                street = ''
                ...
                data = {
                    ...
                    "Shipment": {
                        ...
                        "Shipper": {
                            ...
                            "ShipperNumber": self.carrier_id.carrier_account_id.ups_api_username,
                            "Address": {
                        ...
                        "PaymentInformation": {
                            "ShipmentCharge": {
                                "Type": "01",
                                "BillShipper": {
                                    "AccountNumber": self.carrier_id.carrier_account_id.ups_api_username
                                }
                            }
                        },
                        "Service": {
                            "Code": self.carrier_id.carrier_account_id.ups_packet_service,
                            "Description": self.carrier_id.carrier_account_id.ups_packet_service_description
                        },
                        "Package": {
                            "Description": "Box",
                            "Packaging": {
                ...
                if self.sale_id:
                    if self.carrier_id.carrier_account_id.ups_cod == True or self.sale_id.payment_mode_id.id == 4:  
